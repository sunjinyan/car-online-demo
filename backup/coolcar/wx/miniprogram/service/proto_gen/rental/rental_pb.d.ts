...
export namespace rental {
    ...
    namespace v1 {
        ...
        /** Represents an UploadFilePhotoRequest. */
        class UploadFilePhotoRequest implements IUploadFilePhotoRequest {

            /**
             * Constructs a new UploadFilePhotoRequest.
             * @param [properties] Properties to set
             */
            constructor(properties?: rental.v1.IUploadFilePhotoRequest);
             ...
             * @param object Plain object
             * @returns UploadFilePhotoRequest
             */
            public static fromObject(object: { [k: string]: any }): rental.v1.UploadFilePhotoRequest;

            /**
             * Creates a plain object from an UploadFilePhotoRequest message. Also converts values to other types if specified.
             * @param message UploadFilePhotoRequest
             * @param [options] Conversion options
             * @returns Plain object
             */
            public static toObject(message: rental.v1.UploadFilePhotoRequest, options?: $protobuf.IConversionOptions): { [k: string]: any };
        ...
        /** Represents an UploadFilePhotoResponse. */
        class UploadFilePhotoResponse implements IUploadFilePhotoResponse {

            /**
             * Constructs a new UploadFilePhotoResponse.
             * @param [properties] Properties to set
             */
            constructor(properties?: rental.v1.IUploadFilePhotoResponse);
             ...
             * @param object Plain object
             * @returns UploadFilePhotoResponse
             */
            public static fromObject(object: { [k: string]: any }): rental.v1.UploadFilePhotoResponse;

            /**
             * Creates a plain object from an UploadFilePhotoResponse message. Also converts values to other types if specified.
             * @param message UploadFilePhotoResponse
             * @param [options] Conversion options
             * @returns Plain object
             */
            public static toObject(message: rental.v1.UploadFilePhotoResponse, options?: $protobuf.IConversionOptions): { [k: string]: any };
        ...
        class ProfileService extends $protobuf.rpc.Service {
             ...
             * @param request UploadFilePhotoRequest message or plain object
             * @param callback Node-style callback called with the error, if any, and UploadFilePhotoResponse
             */
            public uploadFilePhoto(request: rental.v1.IUploadFilePhotoRequest, callback: rental.v1.ProfileService.UploadFilePhotoCallback): void;
             ...
             * @returns Promise
             */
            public uploadFilePhoto(request: rental.v1.IUploadFilePhotoRequest): Promise<rental.v1.UploadFilePhotoResponse>;
        }
        ...
        namespace ProfileService {
             ...
             * @param error Error, if any
             * @param [response] UploadFilePhotoResponse
             */
            type UploadFilePhotoCallback = (error: (Error|null), response?: rental.v1.UploadFilePhotoResponse) => void;
        }
    }
}
