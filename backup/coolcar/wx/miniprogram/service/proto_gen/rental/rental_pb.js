...
export const rental = $root.rental = (() => {
    ...
    rental.v1 = (function() {
        ...
        v1.UpdateTripsRequest = (function() {

            /**
             * Properties of an UpdateTripsRequest.
             * @memberof rental.v1
             * @interface IUpdateTripsRequest
             * @property {string|null} [id] UpdateTripsRequest id
             * @property {rental.v1.ILocation|null} [current] UpdateTripsRequest current
             * @property {boolean|null} [endTrip] UpdateTripsRequest endTrip
             */

            /**
             * Constructs a new UpdateTripsRequest.
             * @memberof rental.v1
             * @classdesc Represents an UpdateTripsRequest.
             * @implements IUpdateTripsRequest
             * @constructor
             * @param {rental.v1.IUpdateTripsRequest=} [properties] Properties to set
             */
            function UpdateTripsRequest(properties) {
                if (properties)
                    for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
             ...
             * @member {string} id
             * @memberof rental.v1.UpdateTripsRequest
             * @instance
             */
            UpdateTripsRequest.prototype.id = "";
             ...
             * @instance
             */
            UpdateTripsRequest.prototype.current = null;
             ...
             * @instance
             */
            UpdateTripsRequest.prototype.endTrip = false;
             ...
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {rental.v1.UpdateTripsRequest} UpdateTripsRequest
             */
            UpdateTripsRequest.fromObject = function fromObject(object) {
                if (object instanceof $root.rental.v1.UpdateTripsRequest)
                    return object;
                let message = new $root.rental.v1.UpdateTripsRequest();
                if (object.id != null)
                    message.id = String(object.id);
                if (object.current != null) {
                    if (typeof object.current !== "object")
                        throw TypeError(".rental.v1.UpdateTripsRequest.current: object expected");
             ...
             * @memberof rental.v1.UpdateTripsRequest
             * @static
             * @param {rental.v1.UpdateTripsRequest} message UpdateTripsRequest
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            UpdateTripsRequest.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                let object = {};
                if (options.defaults) {
             ...
             * @returns {Object.<string,*>} JSON object
             */
            UpdateTripsRequest.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };

            return UpdateTripsRequest;
        })();
        ...
        v1.TripService = (function() {
             ...
             * @memberof rental.v1.TripService
             * @instance
             * @param {rental.v1.IUpdateTripsRequest} request UpdateTripsRequest message or plain object
            ...
            Object.defineProperty(TripService.prototype.updateTrip = function updateTrip(request, callback) {
                return this.rpcCall(updateTrip, $root.rental.v1.UpdateTripsRequest, $root.rental.v1.Trip, request, callback);
         ...
         * @enum {number}
         * @property {number} UNSUBMITED=0 UNSUBMITED value
         */
        v1.IdentityStatus = (function() {
            const valuesById = {}, values = Object.create(valuesById);
            values[valuesById[0] = "UNSUBMITED"] = 0;
            return values;
        })();
        ...
        v1.Profile = (function() {
             ...
             * @memberof rental.v1
             * @classdesc 值类型 一个account_id 可以映射到的信息，给一个account_id可以联想到的事物
            ...
            Profile.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    object.identityStatus = options.enums === String ? "UNSUBMITED" : 0;
                }
        ...
        v1.UploadFilePhotoRequest = (function() {

            /**
             * Properties of an UploadFilePhotoRequest.
             * @memberof rental.v1
             * @interface IUploadFilePhotoRequest
             * @property {string|null} [fileName] UploadFilePhotoRequest fileName
             */

            /**
             * Constructs a new UploadFilePhotoRequest.
             * @memberof rental.v1
             * @classdesc Represents an UploadFilePhotoRequest.
             * @implements IUploadFilePhotoRequest
             * @constructor
             * @param {rental.v1.IUploadFilePhotoRequest=} [properties] Properties to set
             */
            function UploadFilePhotoRequest(properties) {
                if (properties)
                    for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
            ...
            /**
             * UploadFilePhotoRequest fileName.
             * @member {string} fileName
             * @memberof rental.v1.UploadFilePhotoRequest
             * @instance
             */
            UploadFilePhotoRequest.prototype.fileName = "";

            /**
             * Creates an UploadFilePhotoRequest message from a plain object. Also converts values to their respective internal types.
             * @function fromObject
             * @memberof rental.v1.UploadFilePhotoRequest
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {rental.v1.UploadFilePhotoRequest} UploadFilePhotoRequest
             */
            UploadFilePhotoRequest.fromObject = function fromObject(object) {
                if (object instanceof $root.rental.v1.UploadFilePhotoRequest)
                    return object;
                let message = new $root.rental.v1.UploadFilePhotoRequest();
            ...
            /**
             * Creates a plain object from an UploadFilePhotoRequest message. Also converts values to other types if specified.
             * @function toObject
             * @memberof rental.v1.UploadFilePhotoRequest
             * @static
             * @param {rental.v1.UploadFilePhotoRequest} message UploadFilePhotoRequest
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            UploadFilePhotoRequest.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                let object = {};
                if (options.defaults)
            ...
            /**
             * Converts this UploadFilePhotoRequest to JSON.
             * @function toJSON
             * @memberof rental.v1.UploadFilePhotoRequest
             * @instance
             * @returns {Object.<string,*>} JSON object
             */
            UploadFilePhotoRequest.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };

            return UploadFilePhotoRequest;
        })();

        v1.UploadFilePhotoResponse = (function() {

            /**
             * Properties of an UploadFilePhotoResponse.
             * @memberof rental.v1
             * @interface IUploadFilePhotoResponse
             * @property {string|null} [url] UploadFilePhotoResponse url
             */

            /**
             * Constructs a new UploadFilePhotoResponse.
             * @memberof rental.v1
             * @classdesc Represents an UploadFilePhotoResponse.
             * @implements IUploadFilePhotoResponse
             * @constructor
             * @param {rental.v1.IUploadFilePhotoResponse=} [properties] Properties to set
             */
            function UploadFilePhotoResponse(properties) {
                if (properties)
                    for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                        if (properties[keys[i]] != null)
                            this[keys[i]] = properties[keys[i]];
            ...
            /**
             * UploadFilePhotoResponse url.
             * @member {string} url
             * @memberof rental.v1.UploadFilePhotoResponse
             * @instance
             */
            UploadFilePhotoResponse.prototype.url = "";

            /**
             * Creates an UploadFilePhotoResponse message from a plain object. Also converts values to their respective internal types.
             * @function fromObject
             * @memberof rental.v1.UploadFilePhotoResponse
             * @static
             * @param {Object.<string,*>} object Plain object
             * @returns {rental.v1.UploadFilePhotoResponse} UploadFilePhotoResponse
             */
            UploadFilePhotoResponse.fromObject = function fromObject(object) {
                if (object instanceof $root.rental.v1.UploadFilePhotoResponse)
                    return object;
                let message = new $root.rental.v1.UploadFilePhotoResponse();
                if (object.url != null)
                    message.url = String(object.url);
                return message;
            };
            ...
            /**
             * Creates a plain object from an UploadFilePhotoResponse message. Also converts values to other types if specified.
             * @function toObject
             * @memberof rental.v1.UploadFilePhotoResponse
             * @static
             * @param {rental.v1.UploadFilePhotoResponse} message UploadFilePhotoResponse
             * @param {$protobuf.IConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
            UploadFilePhotoResponse.toObject = function toObject(message, options) {
                if (!options)
                    options = {};
                let object = {};
                if (options.defaults)
            ...
            /**
             * Converts this UploadFilePhotoResponse to JSON.
             * @function toJSON
             * @memberof rental.v1.UploadFilePhotoResponse
             * @instance
             * @returns {Object.<string,*>} JSON object
             */
            UploadFilePhotoResponse.prototype.toJSON = function toJSON() {
                return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
            };

            return UploadFilePhotoResponse;
        })();
        ...
        v1.ProfileService = (function() {
            ...
            /**
             * Callback as used by {@link rental.v1.ProfileService#uploadFilePhoto}.
             * @memberof rental.v1.ProfileService
             * @typedef UploadFilePhotoCallback
             * @type {function}
             * @param {Error|null} error Error, if any
             * @param {rental.v1.UploadFilePhotoResponse} [response] UploadFilePhotoResponse
             */

            /**
             * Calls UploadFilePhoto.
             * @function uploadFilePhoto
             * @memberof rental.v1.ProfileService
             * @instance
             * @param {rental.v1.IUploadFilePhotoRequest} request UploadFilePhotoRequest message or plain object
             * @param {rental.v1.ProfileService.UploadFilePhotoCallback} callback Node-style callback called with the error, if any, and UploadFilePhotoResponse
             * @returns {undefined}
             * @variation 1
             */
            Object.defineProperty(ProfileService.prototype.uploadFilePhoto = function uploadFilePhoto(request, callback) {
                return this.rpcCall(uploadFilePhoto, $root.rental.v1.UploadFilePhotoRequest, $root.rental.v1.UploadFilePhotoResponse, request, callback);
            }, "name", { value: "UploadFilePhoto" });
             ...
             * @instance
             * @param {rental.v1.IUploadFilePhotoRequest} request UploadFilePhotoRequest message or plain object
             * @returns {Promise<rental.v1.UploadFilePhotoResponse>} Promise
             * @variation 2
             */
