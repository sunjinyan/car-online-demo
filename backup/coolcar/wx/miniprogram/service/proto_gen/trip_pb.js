...
export const coolcar = $root.coolcar = (() => {
    ...
    coolcar.LocationStatus = (function() {

        /**
         * Properties of a LocationStatus.
         * @memberof coolcar
         * @interface ILocationStatus
         * @property {coolcar.ILocation|null} [location] LocationStatus location
         ...
         * @constructor
         * @param {coolcar.ILocationStatus=} [properties] Properties to set
         */
         ...
         * @member {coolcar.ILocation|null|undefined} location
         * @memberof coolcar.LocationStatus
         * @instance
         */
         ...
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {coolcar.LocationStatus} LocationStatus
         */
        LocationStatus.fromObject = function fromObject(object) {
            if (object instanceof $root.coolcar.LocationStatus)
                return object;
            let message = new $root.coolcar.LocationStatus();
            if (object.location != null) {
                if (typeof object.location !== "object")
                    throw TypeError(".coolcar.LocationStatus.location: object expected");
                message.location = $root.coolcar.Location.fromObject(object.location);
            }
         ...
         * @memberof coolcar.LocationStatus
         * @static
         * @param {coolcar.LocationStatus} message LocationStatus
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        LocationStatus.toObject = function toObject(message, options) {
            ...
            if (message.location != null && message.hasOwnProperty("location"))
                object.location = $root.coolcar.Location.toObject(message.location, options);
    ...
    coolcar.TripEntity = (function() {
         ...
         * @property {coolcar.ITrip|null} [trip] TripEntity trip
         */
         ...
         * @constructor
         * @param {coolcar.ITripEntity=} [properties] Properties to set
         */
         ...
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {coolcar.TripEntity} TripEntity
         */
        TripEntity.fromObject = function fromObject(object) {
            if (object instanceof $root.coolcar.TripEntity)
                return object;
            let message = new $root.coolcar.TripEntity();
            if (object.id != null)
                message.id = String(object.id);
            if (object.trip != null) {
                if (typeof object.trip !== "object")
                    throw TypeError(".coolcar.TripEntity.trip: object expected");
         ...
         * @memberof coolcar.TripEntity
         * @static
         * @param {coolcar.TripEntity} message TripEntity
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
    ...
    coolcar.Trip = (function() {
         ...
         * @property {coolcar.ILocationStatus|null} [start] Trip start
         * @property {coolcar.ILocationStatus|null} [current] Trip current
         * @property {coolcar.ILocationStatus|null} [end] Trip end
        ...
        /**
         * Trip start.
         * @member {coolcar.ILocationStatus|null|undefined} start
         * @memberof coolcar.Trip
         * @instance
         */
        ...
        /**
         * Trip current.
         * @member {coolcar.ILocationStatus|null|undefined} current
         * @memberof coolcar.Trip
         * @instance
         */
        ...
        /**
         * Trip end.
         * @member {coolcar.ILocationStatus|null|undefined} end
         * @memberof coolcar.Trip
         * @instance
         */
        ...
        Trip.fromObject = function fromObject(object) {
            ...
            if (object.start != null) {
                if (typeof object.start !== "object")
                    throw TypeError(".coolcar.Trip.start: object expected");
                message.start = $root.coolcar.LocationStatus.fromObject(object.start);
            }
            if (object.current != null) {
                if (typeof object.current !== "object")
                    throw TypeError(".coolcar.Trip.current: object expected");
                message.current = $root.coolcar.LocationStatus.fromObject(object.current);
            }
            if (object.end != null) {
                if (typeof object.end !== "object")
                    throw TypeError(".coolcar.Trip.end: object expected");
                message.end = $root.coolcar.LocationStatus.fromObject(object.end);
            }
        ...
        Trip.toObject = function toObject(message, options) {
            ...
            if (message.start != null && message.hasOwnProperty("start"))
                object.start = $root.coolcar.LocationStatus.toObject(message.start, options);
            if (message.end != null && message.hasOwnProperty("end"))
                object.end = $root.coolcar.LocationStatus.toObject(message.end, options);
            if (message.current != null && message.hasOwnProperty("current"))
                object.current = $root.coolcar.LocationStatus.toObject(message.current, options);
    ...
    coolcar.CreateTripRequest = (function() {

        /**
         * Properties of a CreateTripRequest.
         * @memberof coolcar
         * @interface ICreateTripRequest
         * @property {coolcar.ILocation|null} [start] CreateTripRequest start
         ...
         * @constructor
         * @param {coolcar.ICreateTripRequest=} [properties] Properties to set
         */
         ...
         * @member {coolcar.ILocation|null|undefined} start
         * @memberof coolcar.CreateTripRequest
         * @instance
         */
         ...
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {coolcar.CreateTripRequest} CreateTripRequest
         */
        CreateTripRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.coolcar.CreateTripRequest)
                return object;
            let message = new $root.coolcar.CreateTripRequest();
            if (object.start != null) {
                if (typeof object.start !== "object")
                    throw TypeError(".coolcar.CreateTripRequest.start: object expected");
                message.start = $root.coolcar.Location.fromObject(object.start);
            }
            if (object.carId != null)
                message.carId = String(object.carId);
         ...
         * @memberof coolcar.CreateTripRequest
         * @static
         * @param {coolcar.CreateTripRequest} message CreateTripRequest
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        CreateTripRequest.toObject = function toObject(message, options) {
            ...
            if (message.start != null && message.hasOwnProperty("start"))
                object.start = $root.coolcar.Location.toObject(message.start, options);
            if (message.carId != null && message.hasOwnProperty("carId"))
                object.carId = message.carId;
    ...
    coolcar.GetTripsRequest = (function() {

        /**
         * Properties of a GetTripsRequest.
         * @memberof coolcar
         * @interface IGetTripsRequest
         * @property {coolcar.TripStatus|null} [status] GetTripsRequest status
         */
         ...
         * @constructor
         * @param {coolcar.IGetTripsRequest=} [properties] Properties to set
         */
         ...
         * @member {coolcar.TripStatus} status
         * @memberof coolcar.GetTripsRequest
         * @instance
         */
         ...
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {coolcar.GetTripsRequest} GetTripsRequest
         */
        GetTripsRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.coolcar.GetTripsRequest)
                return object;
            let message = new $root.coolcar.GetTripsRequest();
            switch (object.status) {
            case "TS_NOT_SPECIFIED":
            case 0:
                message.status = 0;
         ...
         * @memberof coolcar.GetTripsRequest
         * @static
         * @param {coolcar.GetTripsRequest} message GetTripsRequest
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
    ...
    coolcar.GetTripsResponse = (function() {

        /**
         * Properties of a GetTripsResponse.
         * @memberof coolcar
         * @interface IGetTripsResponse
         * @property {Array.<coolcar.ITripEntity>|null} [trips] GetTripsResponse trips
         */
         ...
         * @constructor
         * @param {coolcar.IGetTripsResponse=} [properties] Properties to set
         */
         ...
         * @member {Array.<coolcar.ITripEntity>} trips
         * @memberof coolcar.GetTripsResponse
         * @instance
         */
         ...
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {coolcar.GetTripsResponse} GetTripsResponse
         */
        GetTripsResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.coolcar.GetTripsResponse)
                return object;
            let message = new $root.coolcar.GetTripsResponse();
            if (object.trips) {
                if (!Array.isArray(object.trips))
                    throw TypeError(".coolcar.GetTripsResponse.trips: array expected");
                message.trips = [];
                for (let i = 0; i < object.trips.length; ++i) {
                    if (typeof object.trips[i] !== "object")
                        throw TypeError(".coolcar.GetTripsResponse.trips: object expected");
                    message.trips[i] = $root.coolcar.TripEntity.fromObject(object.trips[i]);
                }
            }
            return message;
        };
         ...
         * @memberof coolcar.GetTripsResponse
         * @static
         * @param {coolcar.GetTripsResponse} message GetTripsResponse
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        GetTripsResponse.toObject = function toObject(message, options) {
            ...
            if (message.trips && message.trips.length) {
                ...
                for (let j = 0; j < message.trips.length; ++j)
                    object.trips[j] = $root.coolcar.TripEntity.toObject(message.trips[j], options);
            }
            return object;
        };
    ...
    coolcar.UpdateTripRequest = (function() {
         ...
         * @property {coolcar.ILocation|null} [current] UpdateTripRequest current
         ...
         * @constructor
         * @param {coolcar.IUpdateTripRequest=} [properties] Properties to set
         */
         ...
         * @member {string} id
         * @memberof coolcar.UpdateTripRequest
         * @instance
         */
         ...
         * @member {coolcar.ILocation|null|undefined} current
         * @memberof coolcar.UpdateTripRequest
         * @instance
         */
         ...
         * @static
         * @param {Object.<string,*>} object Plain object
         * @returns {coolcar.UpdateTripRequest} UpdateTripRequest
         */
        UpdateTripRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.coolcar.UpdateTripRequest)
                return object;
            let message = new $root.coolcar.UpdateTripRequest();
            if (object.id != null)
                message.id = String(object.id);
            if (object.current != null) {
                if (typeof object.current !== "object")
                    throw TypeError(".coolcar.UpdateTripRequest.current: object expected");
                message.current = $root.coolcar.Location.fromObject(object.current);
            }
         ...
         * @memberof coolcar.UpdateTripRequest
         * @static
         * @param {coolcar.UpdateTripRequest} message UpdateTripRequest
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        UpdateTripRequest.toObject = function toObject(message, options) {
            ...
            if (message.id != null && message.hasOwnProperty("id"))
                object.id = message.id;
            if (message.current != null && message.hasOwnProperty("current"))
                object.current = $root.coolcar.Location.toObject(message.current, options);
    ...
    coolcar.TripService = (function() {
         ...
         * @param {coolcar.TripEntity} [response] TripEntity
         */
         ...
         * @memberof coolcar.TripService
         * @instance
         * @param {coolcar.ICreateTripRequest} request CreateTripRequest message or plain object
         * @param {coolcar.TripService.CreateTripCallback} callback Node-style callback called with the error, if any, and TripEntity
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(TripService.prototype.createTrip = function createTrip(request, callback) {
            return this.rpcCall(createTrip, $root.coolcar.CreateTripRequest, $root.coolcar.TripEntity, request, callback);
         ...
         * @instance
         * @param {coolcar.ICreateTripRequest} request CreateTripRequest message or plain object
         * @returns {Promise<coolcar.TripEntity>} Promise
         * @variation 2
         */
         ...
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {coolcar.Trip} [response] Trip
         */
         ...
         * @param {coolcar.TripService.GetTripCallback} callback Node-style callback called with the error, if any, and Trip
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(TripService.prototype.getTrip = function getTrip(request, callback) {
            return this.rpcCall(getTrip, $root.coolcar.GetTripRequest, $root.coolcar.Trip, request, callback);
        }, "name", { value: "GetTrip" });
         ...
         * @instance
         * @param {coolcar.IGetTripRequest} request GetTripRequest message or plain object
         * @returns {Promise<coolcar.Trip>} Promise
         * @variation 2
         */
         ...
         * @type {function}
         * @param {Error|null} error Error, if any
         * @param {coolcar.GetTripsResponse} [response] GetTripsResponse
         */
         ...
         * @memberof coolcar.TripService
         * @instance
         * @param {coolcar.IGetTripsRequest} request GetTripsRequest message or plain object
         * @param {coolcar.TripService.GetTripsCallback} callback Node-style callback called with the error, if any, and GetTripsResponse
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(TripService.prototype.getTrips = function getTrips(request, callback) {
            return this.rpcCall(getTrips, $root.coolcar.GetTripsRequest, $root.coolcar.GetTripsResponse, request, callback);
        }, "name", { value: "GetTrips" });
         ...
         * @instance
         * @param {coolcar.IGetTripsRequest} request GetTripsRequest message or plain object
         * @returns {Promise<coolcar.GetTripsResponse>} Promise
         * @variation 2
         */
         ...
         * @memberof coolcar.TripService
         * @instance
         * @param {coolcar.IUpdateTripRequest} request UpdateTripRequest message or plain object
         * @param {coolcar.TripService.UpdateTripCallback} callback Node-style callback called with the error, if any, and Trip
         * @returns {undefined}
         * @variation 1
         */
        Object.defineProperty(TripService.prototype.updateTrip = function updateTrip(request, callback) {
            return this.rpcCall(updateTrip, $root.coolcar.UpdateTripRequest, $root.coolcar.Trip, request, callback);
