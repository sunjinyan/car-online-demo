...
type Trip struct {
	...
	Start         string      `protobuf:"bytes,1,opt,name=start,proto3" json:"start,omitempty"` //第一个字段是start
	End           string      `protobuf:"bytes,2,opt,name=end,proto3" json:"end,omitempty"`     //第二个字段是end，原因是二进制数据流，不像json可以有明确的字段位置标识，但是二进制并不知道从哪里开始，到哪里结束，所以需要告诉解析器，第一个字段叫start第二个字段叫end
	...
	PathLocations []*Location `protobuf:"bytes,7,rep,name=path_locations,json=pathLocations,proto3" json:"path_locations,omitempty"` //[]*Location 会翻译成切片指针
	...
	//如何让每个字段正确的拥有0值
	IsPromotionTrip bool `protobuf:"varint,9,opt,name=isPromotionTrip,proto3" json:"isPromotionTrip,omitempty"` //yes
	//bool isFromLoggedInUser = 10;//no
	IsFromGuestUser bool `protobuf:"varint,10,opt,name=isFromGuestUser,proto3" json:"isFromGuestUser,omitempty"` //yes  为了兼容新老系统，如果该字段是后期添加的使用在新系统中，那么上述的10里边表达就是错误的
}
...
var file_trip_proto_rawDesc = []byte{
	...
	0x52, 0x09, 0x6c, 0x6f, 0x6e, 0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x22, 0x83, 0x03, 0x0a, 0x04,
	...
	0x0f, 0x69, 0x73, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x72, 0x69, 0x70,
	0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x69, 0x73, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74,
	0x69, 0x6f, 0x6e, 0x54, 0x72, 0x69, 0x70, 0x12, 0x28, 0x0a, 0x0f, 0x69, 0x73, 0x46, 0x72, 0x6f,
	0x6d, 0x47, 0x75, 0x65, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x0f, 0x69, 0x73, 0x46, 0x72, 0x6f, 0x6d, 0x47, 0x75, 0x65, 0x73, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x22, 0x20, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x52, 0x65, 0x71, 0x75,
	...
	0x04, 0x50, 0x41, 0x49, 0x44, 0x10, 0x04, 0x32, 0x4b, 0x0a, 0x0b, 0x54, 0x72, 0x69, 0x70, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3c, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69,
	0x70, 0x12, 0x17, 0x2e, 0x63, 0x6f, 0x6f, 0x6c, 0x63, 0x61, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x54,
	0x72, 0x69, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x63, 0x6f, 0x6f,
	0x6c, 0x63, 0x61, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x70, 0x52, 0x65, 0x73, 0x70,
